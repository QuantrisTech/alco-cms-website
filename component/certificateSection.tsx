...
export default function CertificatesSection({
  ...
  return (
    <section className="py-6 md:py-8 lg:py-12 xl:py-16 px-4 bg-dark-primary bg-cover w-full">
      <div className="container mx-auto">

        {/* Header */}
        <div className="mb-10">
          <span className="text-[#FFD700] w-fit text-xs font-extrabold uppercase tracking-[2.5px] mb-2 border border-yellow-300 rounded-2xl bg-yellow-50/20 drop-shadow-md px-4 py-2 inline-block">
            {badge}
          </span>
